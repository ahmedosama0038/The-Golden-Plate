...
export default function ReviewsPage() {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      // 🎯 تعديل مهم: بنعمل invalidate للـ Keys بتوع الأدمن والعميل مع بعض عشان التحديث يبقى مسمّع في الموقع كله لايف
        ...
        {!isLoading && (
          <div className="adm-table-wrap"> {/* */}
            ...
            <table>
              ...
              <tbody>
                {reviews.map((r) => {
                  // تأمين مسارات الـ Keys كابيتال وسمول حسب الـ Swagger
                  const id = r.id || r.Id || r.ID
                  const customerId = r.customerId || r.CustomerId || r.customerId || '—' //
                  
                  // 🎯 تأمين قراءة الـ Rating عشان النجوم تفرش دهب وتظهر في الجدول
                  ...
                  return (
                    <tr key={id}>
                      ...
                      <td style={{ fontWeight: 600 }}>Client #00{customerId}</td> {/* */}
                      
                      {/* 🎯 هنا النجوم هتظهر مضمونة 100% بعد الحماية والتعديل الشامل فوق */}
